  ...
  return (
    <>
      ...
      >
        ...
        {/* ================= ELITE HERO SEARCH ================= */}
<div className="absolute bottom-52 left-1/2 -translate-x-1/2 w-full px-6">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mt-10">
            <Link
              to="/cars"
              className="inline-block border-2 border-blue-900 text-blue-900 bg-transparent px-8 py-3 rounded-lg font-medium transition hover:bg-blue-900 hover:text-white"
            >
              Explore All Cars →
            </Link>
          </div>
...
<section className="py-20 bg-white">
  <div className="max-w-7xl mx-auto px-4">
    ...
    <div className="grid md:grid-cols-3 gap-12">
      ...
      {/* STEP 1 */}
      <div className="relative text-center p-8 pt-20 rounded-2xl shadow-md bg-white hover:shadow-xl transition transform hover:-translate-y-1">

        {/* Number Circle */}
        <div className="absolute -top-10 left-1/2 -translate-x-1/2 
                        w-20 h-20 rounded-full 
                        bg-white-900 text-blue-900 
  ...
  <Search className="w-10 h-10 text-blue-700" strokeWidth={2.2} />
</div>
      ...
      <div className="relative text-center p-8 pt-20 rounded-2xl shadow-md bg-white hover:shadow-xl transition transform hover:-translate-y-1">
        ...
        <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-blue-50 flex items-center justify-center">
  <CalendarCheck className="w-10 h-10 text-blue-700" strokeWidth={2.2} />
</div>
      ...
      <div className="relative text-center p-8 pt-20 rounded-2xl shadow-md bg-white hover:shadow-xl transition transform hover:-translate-y-1">
        ...
        <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-blue-50 flex items-center justify-center">
  <Car className="w-10 h-10 text-blue-700" strokeWidth={2.2} />
</div>
...
<section className="py-20 bg-gray-50">
  <div className="max-w-7xl mx-auto px-4">
    ...
    <div className="grid md:grid-cols-4 gap-8">
      ...
      {/* Feature 1 */}
      <div className="bg-white p-8 rounded-2xl shadow-md text-center hover:shadow-xl transition transform hover:-translate-y-1">
        <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-blue-50 flex items-center justify-center">
  <Handshake className="w-7 h-7 text-blue-700" strokeWidth={2.2} />
</div>
      ...
      <div className="bg-white p-8 rounded-2xl shadow-md text-center hover:shadow-xl transition transform hover:-translate-y-1">
        <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-blue-50 flex items-center justify-center">
  <IndianRupee className="w-7 h-7 text-blue-700" strokeWidth={2.2} />
</div>
        <h3 className="font-semibold text-blue-900 text-lg">
          Earn with Your Car
        </h3>
      ...
      <div className="bg-white p-8 rounded-2xl shadow-md text-center hover:shadow-xl transition transform hover:-translate-y-1">
        <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-blue-50 flex items-center justify-center">
  <MapPin className="w-7 h-7 text-blue-700" strokeWidth={2.2} />
</div>
        <h3 className="font-semibold text-blue-900 text-lg">
          Local & Flexible
        </h3>
      ...
      <div className="bg-white p-8 rounded-2xl shadow-md text-center hover:shadow-xl transition transform hover:-translate-y-1">
        <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-blue-50 flex items-center justify-center">
  <ShieldCheck className="w-7 h-7 text-blue-700" strokeWidth={2.2} />
</div>
        <h3 className="font-semibold text-blue-900 text-lg">
          Community Trust
        </h3>
...
<section className="py-28 bg-gray-50">
  <div className="max-w-6xl mx-auto px-4">
    ...
    <div className="relative overflow-hidden rounded-[36px] bg-gradient-to-r from-blue-900 via-blue-700 to-teal-500 px-10 py-20 text-center text-white shadow-xl">

      {/* Decorative Circles */}
      <div className="absolute top-10 left-16 w-40 h-40 rounded-full border border-white/20" />
      <div className="absolute bottom-16 right-20 w-56 h-56 rounded-full border border-white/20" />
      <div className="absolute bottom-24 left-1/3 w-32 h-32 rounded-full border border-white/10" />
      ...
      <p className="mt-5 text-white/80 max-w-2xl mx-auto text-lg">
        Join thousands of satisfied customers who trust Rentify for their car
        rental needs. Browse our selection and book your perfect ride today.
      </p>
      ...
      <div className="flex justify-center gap-6 mt-10 flex-wrap">
        ...
        <Link
          to="/cars"
          className="bg-white text-blue-900 px-10 py-3 rounded-xl font-semibold hover:bg-blue-100 transition flex items-center gap-2"
        >
          Browse & Book Cars →
        </Link>
        ...
        {!isLoggedIn ? (
          <Link
            to="/auth"
            className="bg-white/15 px-10 py-3 rounded-xl font-semibold hover:bg-white hover:text-blue-900 transition"
          >
            Become a Host
          </Link>
        ) : !isHost ? (
