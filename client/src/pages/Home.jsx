  ...
  return (
    <>
      ...
      >
        ...
        {/* HERO CONTENT */}
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center px-4 sm:px-6 lg:px-20 py-16 sm:py-24 lg:py-32 lg:pb-44 gap-8 lg:gap-12 relative z-10">
          {/* LEFT */}
          <div className="flex-1 max-w-2xl lg:max-w-lg">
          ...
          <img
            src={heroImage}
            alt="Car"
            className="w-full sm:max-w-md lg:max-w-2xl object-contain rounded-2xl drop-shadow-2xl flex-1 hidden sm:block"
          />
        </div>
