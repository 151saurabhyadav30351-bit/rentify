...
export default function Home() {
  ...
  return (
    <>
      {/* HERO SECTION */}
      <div
        className="relative overflow-hidden min-h-[90vh] pb-24 md:pb-56"
        style={{
          background: `
            linear-gradient(
              135deg,
      ...
      >
        ...
        {/* HERO CONTENT */}
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-16 py-16 sm:py-24 lg:py-28 lg:pb-44 gap-8 lg:gap-10 relative z-10">
          {/* LEFT */}
          <div className="flex-1 max-w-2xl lg:max-w-[520px]">
            ...
            <p className="mt-4 sm:mt-6 text-base sm:text-lg lg:text-2xl opacity-90">
          ...
          <img
            src={heroImage}
            alt="Car"
            className="w-full sm:max-w-md lg:max-w-[760px] xl:max-w-[820px] object-contain rounded-2xl drop-shadow-2xl flex-1 hidden sm:block"
          />
        </div>
